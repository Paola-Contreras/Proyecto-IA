...
def get_recommendations(user_id):
    ...
    recommendations_with_metadata = pd.merge(recommendations, movies_metadata_df[['id', 'title', 'overview']], left_on='movieId', right_on='id', how='left')
...
print(recommendations[['title', 'overview', 'predicted_rating']])
